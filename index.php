...
<main class="wd-page">
  ...
  <!-- DIVE SITES HIDDEN -->
<!-- EQUIPMENT -->
  <section id="equipment" class="wd-section white wd-center wd-eq"><div class="wd-shell"><div class="wd-divider"><h2 class="wd-title">Scuba Equipment for Sale</h2></div><p class="wd-sub">Essential gear categories for training, fun dives, and safer underwater comfort.</p><div class="wd-equipment-grid"><?php $eq=[['Masks','Clear vision and reliable fit','wdc-mask-compressed.png'],['Wetsuits','Thermal comfort for longer dives','wdc-wetsuit-compressed.png'],['BCD','Buoyancy control and trim support','wdc-bcd-compressed.png'],['Regulators','Smooth breathing and safe air delivery','wdc-regulators-compressed.png'],['Fins','Efficient movement with less fatigue','wdc-fins-compressed.png'],['Dive Computers','Track depth, time, tank pressure, and safer ascent data','wdc-dive-computer-compressed.png']]; foreach($eq as $e): ?><article class="wd-equip-card"><figure class="wd-equip-photo"><img loading="lazy" decoding="async" src="<?php echo esc_url(get_stylesheet_directory_uri()); ?>/assets/<?php echo esc_attr($e[2]); ?>" alt="<?php echo esc_attr($e[0]); ?> scuba equipment product photo"></figure><h3><?php echo esc_html($e[0]); ?></h3><p><?php echo esc_html($e[1]); ?></p><span>View product</span></article><?php endforeach; ?></div></div></section>
